...
def sentiment_analysis_blob(review):
...
linkedin_data['Sentiment'] = linkedin_data['Review'].apply(sentiment_analysis_blob)
...
# Method to generate word cloud for each sentiment
